package com.flower.common.utils.file;
...
import com.flower.common.exception.file.FileNameLengthLimitExceededException;
import com.flower.common.exception.file.FileSizeLimitExceededException;
import com.flower.common.exception.file.InvalidExtensionException;
import com.flower.common.utils.DateUtils;
import com.flower.common.utils.StringUtils;
import com.flower.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
            ...
            InvalidExtensionException
    {
        ...
        File desc = null;
        if (fileName == null){
            String fileName1 = extractFilename(file,null);

            desc = getAbsoluteFile(baseDir, fileName1);
        }else {
            String fileName1 = extractFilename(file,fileName);
    ...
    public static final String extractFilename(MultipartFile file,String fileName)
    {
        if (fileName == null){
            return StringUtils.format("{}.{}",
                    file.getName(), getExtension(file));
        }else {
            return StringUtils.format("{}.{}",
